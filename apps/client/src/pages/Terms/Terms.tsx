        ...
        <>
            ...
            <section className={styles.section}>
                ...
                <p>This agreement, and all schedules and appendices attached or referred hereto, if any,
                   ...
                   a connection to the website and internet service known as rcmenu.com and RCMenu.com owned by 
            ...
            <section className={styles.section}>
                ...
                <ul>
                    ...
                    <li><b>Platform</b> - means the online platform (website, mobile site or mobile application) developed and/or operated by RCMenu.</li>
                    <li><b>Service</b> - means the services and features provided or made available by RCMenu through or on the Platform.</li>
                    <li><b>User/Users</b> - means all users who access or establish a connection to the Platform and/or RCMenu Services.</li>
            ...
            <section className={styles.section}>
                ...
                <p>
                    ...
                    with the registration process set out by RCMenu. Upon successful registration, User may be given access 
                    to RCMenu Services by logging in to User's Account.
                </p>
                <p>
                    RCMenu is entitled, in its sole and absolute discretion, to refuse to grant access to the User 
                    to the Platform and RCMenu Services or any part thereof.
                </p>
                <p>
                    By submitting or uploading any Information on or through the Platform and/or RCMenu Services, 
                    User is automatically grants, or warrants that the owner of such Information has expressly granted,
                    RCMenu the royalty-free, perpetual, irrevocable, non-exclusive right and license to reproduce, share,
                ...
                <p>
                    ...
                    and/or RCMenu Services any Information which is or may be unlawful, technologically harmful, threatening, abusive, 
                ...
                <p>
                    User ensures that all Information provided to RCMenu or published on the Platform by User is true,
                    complete, accurate and up-to-date and that User have all the necessary authority and right to publish or 
                    provide such Information. User warrant that RCMenu’s use of any such Information will not infringe the right 
            ...
            <section className={styles.section}>
                ...
                <p>
                    ...
                    RCMenu Services. In order to continue using the Service after the end of the trial time period and to have 
                ...
                <p>
                    ...
                    RCMenu does not provide refunds for any partial subscription periods.
                    To cancel the subscription please <HashLink className={styles.link} to="/#contacts">contact us</HashLink>.
                </p>
                <p>
                    RCMenu reserves the right, in its sole discretion, to change fees, including, but not limited to, 
                ...
                <p>
                    If RCMenu elects to change its fees it will post notice on the Platform of all provisions pertaining to 
                    fees and payments at least one calendar month before it comes into effect.
                </p>
                <p>
                    RCMenu reserves the right to charge fees in UAH currency in accordance with Ukrainian laws.
                </p>
                <p>
            ...
            <section className={styles.section}>
                ...
                <p>
                    The Service is provided on an "as is" and “as available” basis. RCMenu makes no warranties, expressed or implied, 
                ...
                <p>
                    Information made available through the Platform or RCMenu Services may be furnished to RCMenu by third parties,
                    including without limitation other users of the Platform. While RCMenu will use reasonable endeavours to 
                    ensure that such Information is communicated to User in its original form as supplied by the third party, 
                    RCMenu does not warrant that the said Information is accurate, complete, reliable, original, current, 
                    or error-free.
                </p>
                <p>
                    In no event will RCMenu (or any of its parents, subsidiaries, affiliates, employees, staff, and their 
                ...
                <p>
                    RCMenu shall have the right at any time to add, delete, amend, or modify this Agreement, or any part thereof, 
                    ...
                    Any use of the Platform and/or RCMenu Services after the issuance of such notice shall be deemed to constitute
